...
async function main(nid,uniqueCode,AssetCode,PreviousOwnerNid,PreviousOwnerName,NewOwnerNID,NewOwnerName,Time,Result,OwnerNID,RequestedByNID) {
    try {
        ...
        await contract.submitTransaction('createNotification', uniqueCode , AssetCode , PreviousOwnerNid , PreviousOwnerName , NewOwnerNID , NewOwnerName,Time,Result,OwnerNID,RequestedByNID,"LoanNotification");
