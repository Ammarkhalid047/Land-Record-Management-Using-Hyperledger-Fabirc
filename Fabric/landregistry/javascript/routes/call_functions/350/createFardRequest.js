...
async function main(OwnerNID,RequestType,OwnerName,RequestedByNID,RequestedByName,AssetName,AssetCode ,Time) {
    try {
        ...
        await contract.submitTransaction('createRequest', AssetCode+'FR' , OwnerNID , RequestType, AssetName , RequestedByNID , AssetCode ,RequestedByName, Time,OwnerName);
