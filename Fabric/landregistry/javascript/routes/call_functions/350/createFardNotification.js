...
async function main(nid,uniqueCode,AssetCode,fard,NewOwnerNID,NewOwnerName,Time,Result,OwnerNID,RequestedByNID,FardNID) {
    try {
        ...
        await contract.submitTransaction('createFardNotification', uniqueCode ,fard, AssetCode , NewOwnerNID , "",Time,Result,OwnerNID,RequestedByNID,FardNID,"FardNotification");
